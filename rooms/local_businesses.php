    ...
    if ($title !== '' && $body !== '') {
        $repo->addPost([
            ...
            'location' => $location,
                ...
                header('Location: local_businesses.php');
        exit;
    }
}

$posts = $repo->search(null, null, $topic);
$topicLabel = 'Local Businesses';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="feed-header">
        <div class="feed-header-content">
            <div class="feed-branding">
                <img src="../assets/local_businesses.jpeg" alt="Traffic logo" class="feed-logo">
                <h1>t/Local Businesses</h1>
            </div>
